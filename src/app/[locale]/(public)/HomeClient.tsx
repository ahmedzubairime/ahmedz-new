...
export default function HomeClient({
    ...
    return (
        <>
            {/* ═══════════════════════════════════════════════
                SECTION 1: نبذة موجزة عني — About Brief
            ═══════════════════════════════════════════════ */}
            <section className="relative overflow-hidden bg-slate-50 dark:bg-[#0b1326] transition-colors pt-20 pb-12 sm:pt-28 sm:pb-16">
                ...
                {stats && stats.length > 0 && (
                    <AnimatedSection
                        className="relative mx-auto max-w-5xl px-6 lg:px-8 mt-20"
                        animation="stagger"
                        delay={0.3}
                    >
            ...
            {/* ═══════════════════════════════════════════════
                SECTION 2: أحدث الأخبار والمشاريع
            ═══════════════════════════════════════════════ */}
            ...
            {/* ═══════════════════════════════════════════════
                SECTION 3: شهادات العملاء — Client Testimonials
            ═══════════════════════════════════════════════ */}
            ...
            {/* ═══════════════════════════════════════════════
                SECTION 4: دعوة للتواصل — Contact CTA
            ═══════════════════════════════════════════════ */}
