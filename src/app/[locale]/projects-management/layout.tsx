...
function ProjectsSidebar() {
    ...
    const navItems = [
        { icon: "▦", label: t("board"), href: "/projects-management" },
        { icon: "☰", label: t("list"), href: "/projects-management" },
        { icon: "◷", label: t("timeline"), href: "/projects-management" },
        { icon: "◉", label: t("team"), href: "/projects-management" },
        { icon: "⚙", label: t("settings"), href: "/projects-management" },
    ];
    ...
    return (
        <aside className="hidden w-64 flex-col border-e border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900 lg:flex">
            <div className="flex h-16 items-center border-b border-zinc-200 px-6 dark:border-zinc-800">
                <Link href="/projects-management" className="text-lg font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
                    △ PMS
                </Link>
            </div>
    ...
    return (
        <header className="flex h-16 items-center justify-between border-b border-zinc-200 bg-white px-6 dark:border-zinc-800 dark:bg-zinc-900">
            <div className="lg:hidden">
                <span className="text-lg font-bold text-zinc-900 dark:text-zinc-50">△ PMS</span>
            </div>
